...
mock.onGet('/api/e-commerce-app/products.old').reply(() => {
    return [200, eCommerceDB.products];
});


mock.onGet('/api/e-commerce-app/editProduct').reply((request) => {
    const {productId} = request.params;
    const response = _.find(eCommerceDB.products, {id: productId});
    return [200, response];
});

mock.onPost('/api/e-commerce-app/editProduct/save').reply((request) => {
...
mock.onGet('/api/e-commerce-app/orders2').reply(() => {
    return [200, eCommerceDB.orders];
});

mock.onGet('/api/e-commerce-app/order2').reply((request) => {
