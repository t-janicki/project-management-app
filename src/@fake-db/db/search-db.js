...
const searchDB = [
    ...
    },
    {
        ...
        'excerpt': 'Completely synergize resource taxing relationships via premier niche markets. Professionally cultivate one-to-one customer.old service with robust ideas.'
    },
    {
        'id'     : '4',
        'title'  : 'Parallel Platforms',
        'url'    : 'ourwebaddress.com/articles/parallel-paltforms',
        'excerpt': 'Objectively innovate empowered manufactured products.old whereas parallel platforms. Holisticly predominate extensible testing procedures for reliable supply chains.'
    },
    {
        'id'     : '5',
        'title'  : 'Growth Strategies',
        'url'    : 'ourwebaddress.com/articles/growth-strategies',
        'excerpt': 'Proactively envisioned multimedia based expertise and cross-media growth strategies. Holistically pontificate installed base portals after maintainable products.old.'
    },
    {
        'id'     : '6',
        'title'  : 'Methodologies',
        'url'    : 'ourwebaddress.com/articles/methodologies',
        'excerpt': 'Phosfluorescently engage worldwide methodologies with web-enabled technology. Completely pursue scalable customer.old service through sustainable potentialities.'
    },
    {
        'id'     : '7',
        'title'  : 'E-tailers',
