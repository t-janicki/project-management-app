...
mock.onGet('/api/customers-app/customers').reply((config) => {
...
mock.onGet('/api/customers-app/user').reply((config) => {
    return [200, contactsDB.user[0]];
});

mock.onPost('/api/customers-app/add-contact').reply((request) => {
...
mock.onPost('/api/customers-app/update-contact').reply((request) => {
    const data = JSON.parse(request.data);
...
mock.onPost('/api/customers-app/remove-contact').reply((request) => {
    const data = JSON.parse(request.data);
...
mock.onPost('/api/customers-app/remove-customers').reply((request) => {
    const data = JSON.parse(request.data);
...
mock.onPost('/api/customers-app/toggle-starred-contact').reply((request) => {
    const data = JSON.parse(request.data);
    contactsDB.user[0].starred = _.xor(contactsDB.user[0].starred, [data.contactId]);
    return [200, contactsDB.user[0]];
});

mock.onPost('/api/customers-app/toggle-starred-customers').reply((request) => {
    const data = JSON.parse(request.data);
    contactsDB.user[0].starred = _.xor(contactsDB.user[0].starred, data.contactIds);
    return [200, contactsDB.user[0]];
});

mock.onPost('/api/customers-app/set-customers-starred').reply((request) => {
    const data = JSON.parse(request.data);
...
mock.onPost('/api/customers-app/set-customers-unstarred').reply((request) => {
    const data = JSON.parse(request.data);
