            ...
            <FuseAnimate animation="transition.slideLeftIn" delay={200}>
                <Paper className="rounded-0 shadow-none lg:rounded-8 lg:shadow-1">
                    ...
                    <List>
                        ...
                        >
                            <Icon className="list-item-icon text-16" color="action">store_mall_directory</Icon>
                            <ListItemText className="truncate pr-0" primary="All products" disableTypography={true}/>
                        </ListItem>
                    </List>
                </Paper>
            </FuseAnimate>
