                        ...
                        {!chat ?
                            (
                                <div className="flex flex-col flex-1 items-center justify-center p-24">
                                    ...
                                    <Typography className="hidden md:flex px-16 pb-24 mt-24 text-center"
                                                color="textSecondary">
                                        Select a contact to start a conversation!..
                                    </Typography>
                                    <Button variant="outlined" color="primary" className="flex md:hidden normal-case"
                                        ...
                                        <Toolbar className="px-16">
                                            ...
                                            <div className="flex items-center cursor-pointer"
                                                ...
                                                <Typography color="inherit"
                                                            className="text-18 font-600">{selectedContact.name}</Typography>
                                            </div>
                                        </Toolbar>
                                    </AppBar>
