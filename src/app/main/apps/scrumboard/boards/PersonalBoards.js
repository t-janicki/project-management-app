    ...
    return (
        ...
        >
            {/*<div className="flex flex-grow flex-shrink-0 flex-col items-center container px-16 md:px-24">*/}
                ...
                <FuseAnimate>
                    <Typography className="mt-44 sm:mt-88 sm:py-24 text-32 sm:text-40 font-300" color="inherit">Personal Boards</Typography>
                </FuseAnimate>
...
export default withReducer('scrumboardApp', reducer)(PersonalBoards);
