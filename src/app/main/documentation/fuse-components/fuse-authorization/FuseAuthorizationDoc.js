            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="p">
                        ...
                        It restricts the unauthorized user access with looking <b>route configs</b> and <b>user.userDetailsResponse.role</b>.
                    </Typography>
                    ...
                    <Typography className="mt-48 mb-8" variant="h6">User.userDetailsResponse.role Configuration:</Typography>
                    ...
                    <Typography className="mb-16" component="p">
                        After successful login user.userDetailsResponse.role will be updated and the FuseAuthorization automatically redirects the authorized user.
                    </Typography>
