...
const changelogData = [
    ...
    },
    {
        ...
        newChanges     : [
            ...
            <span>user.userInfo.role can be array to assign multiple permission roles. For details checkout <a
    ...
    },
    {
        ...
        fixedChanges   : [
            ...
            "E-Commerce App, navigating editProduct to new editProduct didn't update the form state.",
    ...
    },
    {
        ...
        fixedChanges: [
            "Synthetically trigger event onChange for higher-order2 components of formsy.",
